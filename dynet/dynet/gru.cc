...
GRUBuilder::GRUBuilder(unsigned layers, unsigned shared_layers, GRUBuilder *_p_obj, unsigned input_dim,
		unsigned hidden_dim, Model &model): hidden_dim(hidden_dim), layers(layers) {
