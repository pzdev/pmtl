...
//  virtual std::vector<std::vector<Parameter>> * get_params() {return nullptr;} //XXX REZA
...
struct SimpleRNNBuilder : public RNNBuilder {
  ...
  explicit SimpleRNNBuilder(unsigned layers, unsigned shared_layers, SimpleRNNBuilder *_p_obj,
                            unsigned input_dim,
                            unsigned hidden_dim,
                            Model& model,
                            bool support_lags = false);
