...
struct LSTMBuilder : public RNNBuilder {
  ...
  explicit LSTMBuilder(unsigned slayers, unsigned shared_slayers, LSTMBuilder *_p_obj,
		  unsigned input_dim, unsigned hidden_dim, Model &model);
...
struct VanillaLSTMBuilder : public RNNBuilder {
  ...
  explicit VanillaLSTMBuilder(unsigned layers, unsigned shared_slayers, VanillaLSTMBuilder *_p_obj,
                               unsigned input_dim,
                               unsigned hidden_dim,
                               Model& model,
                               bool ln_lstm = false);

//  explicit VanillaLSTMBuilder(unsigned slayers, unsigned shared_slayers, std::vector<std::vector<Parameter>> &_params,
//		  unsigned input_dim, unsigned hidden_dim, Model &model, bool ln_lstm = false);
