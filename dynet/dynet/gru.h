...
namespace dynet {
    ...
    struct GRUBuilder : public RNNBuilder {
        ...
        explicit GRUBuilder(unsigned slayers, unsigned shared_layers, GRUBuilder *_p_obj,
        ...
        //info: added by Poorya (for future use)
//        Expression nlayer_back(unsigned n) {concatenate(h[cur]((h[cur].end()-n, h[cur].end())));}
